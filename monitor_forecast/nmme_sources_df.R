...
df_sources <-
  ...
  bind_rows(
    ...
    tibble(model = "canesm5",          end_hindcast = as_date("2024-06-01"), model_cast_url = "CanSIPS-IC4/.CanESM5/.{cast}"),
    tibble(model = "gem5p2-nemo",      end_hindcast = as_date("2024-06-01"), model_cast_url = "CanSIPS-IC4/.GEM5.2-NEMO/.{cast}"),
